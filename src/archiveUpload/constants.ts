...
export const ARCHIVE_LOGIN_PROPERTIES_FILE = `${EGANGOTRI_BASE_DIR}${path.sep}archiveLogins${PROPERTIES}`;
export const ARCHIVE_LOGIN_PROPERTIES_FILE2 = `${EGANGOTRI_BASE_DIR}${path.sep}archiveLogins2${PROPERTIES}`;
export const ARCHIVE_LOGIN_PROPERTIES_FILES = [ARCHIVE_LOGIN_PROPERTIES_FILE, ARCHIVE_LOGIN_PROPERTIES_FILE2]
