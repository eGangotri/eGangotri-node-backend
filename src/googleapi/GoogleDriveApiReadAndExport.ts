...
// const driveLink = "https://drive.google.com/drive/folders/1l1UujNNK0BWV0Pe6yAjeSQfLaPtCZ1R6?usp=drive_link"
// listFolderContentsAndGenerateCSVAndExcel(driveLink, drive, 'Treasures 16');


export const EXPORT_DEST_FOLDER = `E:\\_catalogWork\\_collation\\_catReducedPdfExcels`;
const driveLink = "https://drive.google.com/drive/folders/1PJPhQcxmg-3Cl6vJXdHYjcncvL-sqNrT?usp=drive_link"
listFolderContentsAndGenerateCSVAndExcel(driveLink, drive, 'Treasures 19');
